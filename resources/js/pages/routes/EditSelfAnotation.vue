<template>
    <BaseLayout>
        <template #header>
            <HomeHeader :pageName="`${classroom.name} - Minha Anotação`" />
        </template>
        ...
        <template #content>
            <BaseMainLayout>
                ...
                <template #content>
                    <EditSelfAnotationContent
                        :classes="classes"
                        :anotation="editSelfAnotation"
                    />
                </template>
            </BaseMainLayout>
        </template>
...
<script setup>
    ...
    import EditSelfAnotationContent from '@content/editSelfAnotation/EditSelfAnotationContent.vue';
    import useCollapsedClasses from '@hooks/collapsedClasses';

    const page = usePage();

    const { classroom, classes, editSelfAnotation } = page.props;
