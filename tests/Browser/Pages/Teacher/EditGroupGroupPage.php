...
class EditGroupGroupPage extends Page
{
    ...
    {
        return "/teacher/course/$this->courseName/subject/$this->subjectName/classroom/$this->classroomId/class/$this->classId/group/$this->groupId/group/$this->groupName";
    }
