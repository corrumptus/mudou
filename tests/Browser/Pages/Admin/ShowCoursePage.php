...
class ShowCoursePage extends Page
{
    private string $courseName;

    public function __construct(Browser $browser, string $token, string $courseName) {
    ...
    public function clickEdit() {
        ...
        $this->browser->waitForLocationDecoded("/course/$this->courseName/edit");
    }
}
