...
use Tests\Browser\Pages\Teacher\CourseSubjectPage;
...
class CourseSubjectTest extends DuskTestCase
{
    ...
    public function setUp(): void {
        ...
        Classroom::factory()
            ->hasAttached($this->user, relationship: 'teachers')
            ->count(rand(1, 4))
            ->create();
    ...
    public function testShouldRedirectToTheClassroomPage(): void
    {
        $this->browse(function (Browser $browser) {
            ...
            $url = "/teacher/course/$course/subject/$courseSubject/classroom/$classroomId";
